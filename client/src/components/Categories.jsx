...
function Categories() {
  ...
  const handlegetAllCategories = () => {
    axios
      .get(`http://localhost:5001/api/categories/getallcategories/${UserId}`, {
        headers: {
          Authorization: `Bearer ${import.meta.env.VITE_API_KEY}`,
          "Content-Type": "application/json",
        },
  ...
  const handleDelete = (id) => {
    ...
    if (confirmDelete) {
      axios
        .delete(`http://localhost:5001/api/categories/deletecategory/${id}`, {
          headers: {
            Authorization: `Bearer ${import.meta.env.VITE_API_KEY}`,
            "Content-Type": "application/json",
          },
  ...
  const showCategory = () => {
    axios
      .get(`http://localhost:5001/api/categories/getcategorybyid/${catId}`, {
        headers: {
          Authorization: `Bearer ${import.meta.env.VITE_API_KEY}`,
          "Content-Type": "application/json",
        },
